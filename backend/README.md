...
## Project Structure
    ...
    ├── cypressappkwrmpwq__107141  # Django project configurations
...
1. Clone this repo and `cd cypressappkwrmpwq__107141`
...
2. Clone this repo and `cd cypressappkwrmpwq__107141`
